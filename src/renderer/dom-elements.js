...
const favoriteChannelList = document.getElementById('favoriteChannelList');
const channelBrowser = document.getElementById('channelBrowser');
const channelBrowserThumb = document.getElementById('channelBrowserThumb');
const channelBrowserTitle = document.getElementById('channelBrowserTitle');
